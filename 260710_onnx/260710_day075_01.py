#260710_day075_01_.py
################################################################################
###         onnx 모델적용해보기
################################################################################  
import cv2
import numpy as np
from ultralytics.models.yolo.classify.predict import Predictor
import torch
from ultralytics import YOLO
# YOLO 모델 및 설정 파일 경로 (실제 경로로 변경 필요)
model_cfg = r"C:\yolo\darknet\cfg\yolov3.cfg"
model_weights = r"C:\yolo\darknet\data\yolov3.weights"
#model_onnx = r"C:\yolo\darknet\data\yolov3.onnx"
#cv2.dnn.readNetFromONNX(model_onnx)
...
# 비디오 캡쳐 또는 이미지 읽기
cap = cv2.VideoCapture(r"C:\Users\user\Desktop\objdecsrc\2026-07-07 highway.mp4") # 또는 cv2.imread("image.jpg")
