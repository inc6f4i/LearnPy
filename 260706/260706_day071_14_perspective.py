...
img = cv2.imread(r'C:\Users\user\Desktop\imaging\perspective.png') # 원근 효과 이미지 로드
...
pts1 = np.float32([[766, 691], [348, 1255], [1466, 956], [1900, 1230]])

# 이동할 이미지 좌표 (4개의 점). pts1 좌표에 대응되는 pts2 좌표를 지정
pts2 = np.float32([[10, 10], [10, 1200], [1900, 10], [1900, 1900]])
